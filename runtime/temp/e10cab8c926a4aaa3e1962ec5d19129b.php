<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"F:\phpStudy\PHPTutorial\WWW\bqq\public/../application/admin\view\index\admin_list.html";i:1561950436;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="<?php echo url('admin/index/admin_list'); ?>" method="get">
...
<!-- 仅超级管理添加          -->
<button class="layui-btn" onclick="xadmin.open('添加用户','/admin/index/admin_add',600,400)"><i class="layui-icon"></i>添加</button>
