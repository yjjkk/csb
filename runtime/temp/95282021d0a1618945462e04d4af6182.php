<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\phpStudy\PHPTutorial\WWW\bqq\public/../application/admin\view\index1\index.html";i:1561979075;}*/ ?>
<!doctype html>
            ...
            <ul class="layui-nav right" lay-filter="">
               <!--  <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="<?php echo url('admin/login/index'); ?>">退出</a></dd>
                    </dl>
                </li> -->
                 <li class="layui-nav-item to-index">
                    <a href="">个人信息</a></li>
                 <li class="layui-nav-item to-index">
                    <a href="<?php echo url('admin/login/out'); ?>">退出</a></li>
                <li class="layui-nav-item to-index">
                    <a href="/">前台首页</a></li>
            </ul>
        </div>
                ...
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
<a onclick="xadmin.add_tab('会员列表','<?php echo url('admin/member/memberlist'); ?>')">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('轮播列表','<?php echo url('admin/banner/bannerlist'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>轮播列表</cite></a>
                            </li>
...
<a onclick="xadmin.add_tab('订单列表','<?php echo url('admin/order/orderlist'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>订单列表</cite></a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                <a onclick="xadmin.add_tab('多级分类','<?php echo url('admin/cate/cate'); ?>')">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
<a onclick="xadmin.add_tab('三级地区联动','<?php echo url('city'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>三级地区联动</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
<a onclick="xadmin.add_tab('管理员列表','<?php echo url('admin/index/admin_list'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>管理员列表</cite></a>
                            </li>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src="<?php echo url('admin/index1/welcome'); ?>" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
