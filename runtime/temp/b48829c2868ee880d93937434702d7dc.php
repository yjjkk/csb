<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\phpStudy\PHPTutorial\WWW\Demo\public/../application/index\view\index\index.html";i:1561542697;}*/ ?>
<!doctype html>
            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('管理员列表','<?php echo url('index/admin_list'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>管理员列表</cite></a>
                            </li>
                            <li>
