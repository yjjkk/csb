<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\bqq\public/../application/admin\view\index1\index.html";i:1561696301;}*/ ?>
<!doctype html>
                ...
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('订单列表1','<?php echo url('admin/order/orderlist1'); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>订单列表1</cite></a>
                            </li>
                        </ul>
